module define_hoge
  ...
  integer,parameter:: nb_1dx = 2000, mergin_1dx=10, nbtot_1dx =nb_1dx+mergin_1dx
  ...
  real(8),parameter:: gamma = 5d0/3d0, pi = 3.141592d0, mu=2.
...
! real(8), parameter :: aqalp = 5d0, aqbet = 10d0, eps_vis = 1d-2
